...
class Appliancesbrands extends StatefulWidget {
  @override
  _AppliancesbrandsState createState() => _AppliancesbrandsState();
}

class _AppliancesbrandsState extends State<Appliancesbrands> {
  String brand = null;
